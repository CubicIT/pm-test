	...
	<div class="container">
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="employeeProjects">Assign Employees to
							Porjects</a></li>
					<li><a href="clientProjects">Assign Clients to Porjects</a></li>
					<li><a href="consultantProjects">Assign Consultants to
							Porjects</a></li>
		...
		<form class="form-inline" action="${addAction}" method="post">
			<div class="form-group">
				<label for="consultantId">Select Consultant:</label> <select
			...
			<div class="form-group">
				<label for="projectsId">Select Project(s):</label> <select
					class="form-control" name="projects" id="projectsId"
					multiple="multiple">
								...
								<c:forEach items="${listConsultants}" var="consultant">
									<tr>
										...
										<td><c:if
												...
												<c:forEach items="${consultant.projects}" var="project"
													varStatus="status">
                                                    ${project.name}
                                                <c:if
														test="${status.index+1 != consultant.projects.size()}">,</c:if>
												</c:forEach>
											</c:if></td>
									</tr>
								</c:forEach>
